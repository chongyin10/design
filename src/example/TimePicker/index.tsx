    ...
    <div style={{ padding: '20px' }}>
      <div style={{ display: 'flex', gap: '24px' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <h1 id="timepicker-intro">TimePicker 时间选择器</h1>
          <p>用于选择或输入时间，支持时、分、秒选择。</p>

          {/* 基础用法 */}
          <div id="timepicker-basic">
            <Section title="基础用法">
...
<TimePicker minuteStep={15} placeholder="请选择时间" />`} />
          ...
          {/* 禁用部分时间 */}
          <div id="timepicker-disabled-time">
          ...
          <div style={{ position: 'fixed', top: '100px', right: '40px', width: '140px' }}>
            {scrollContainer && (
              <Anchor
                ...
                bounds={30}
              >
                <Anchor.Link href="#timepicker-intro" title="组件介绍" />
                <Anchor.Link href="#timepicker-basic" title="基础用法" />
                <Anchor.Link href="#timepicker-default" title="默认值" />
                <Anchor.Link href="#timepicker-format" title="时分格式" />
                <Anchor.Link href="#timepicker-label" title="带标签" />
                <Anchor.Link href="#timepicker-disabled" title="禁用状态" />
                <Anchor.Link href="#timepicker-step" title="步长设置" />
                <Anchor.Link href="#timepicker-disabled-time" title="禁用时间" />
                <Anchor.Link href="#timepicker-buttons" title="底部按钮" />
                <Anchor.Link href="#timepicker-range" title="范围选择" />
                <Anchor.Link href="#timepicker-api" title="API 文档" />
              </Anchor>
            )}
          </div>
        </div>
