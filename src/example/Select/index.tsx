        ...
        <div style={{ padding: '20px' }}>
            <div style={{ display: 'flex', gap: '24px' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    <h1 id="select-intro">Select 选择器</h1>
                    ...
                    <div style={{ position: 'fixed', top: '100px', right: '40px', width: '140px' }}>
                        {scrollContainer && (
                            <Anchor
                                ...
                                bounds={30}
                            >
                                <Anchor.Link href="#select-intro" title="组件介绍" />
                                <Anchor.Link href="#select-basic" title="基础用法" />
                                <Anchor.Link href="#select-default" title="默认值" />
                                <Anchor.Link href="#select-size" title="尺寸" />
                                <Anchor.Link href="#select-disabled" title="禁用状态" />
                                <Anchor.Link href="#select-clearable" title="可清除" />
                                <Anchor.Link href="#select-loading" title="加载中" />
                                <Anchor.Link href="#select-searchable" title="可搜索" />
                                <Anchor.Link href="#select-multiple" title="多选模式" />
                                <Anchor.Link href="#select-label" title="带标签" />
                                <Anchor.Link href="#select-event" title="事件回调" />
                                <Anchor.Link href="#select-empty" title="自定义空状态" />
                                <Anchor.Link href="#select-custom" title="自定义样式" />
                                <Anchor.Link href="#select-api" title="API 文档" />
                            </Anchor>
                        )}
                    </div>
                </div>
