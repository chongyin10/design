...
import { Layout, Table, Icon, Flex, Menu, Anchor } from '../../components';
    ...
    <div style={{ padding: '20px' }}>
      <div style={{ display: 'flex', gap: '24px' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <h1 id="layout-intro">Layout 页面布局</h1>
          ...
          <div style={{ position: 'fixed', top: '100px', right: '40px', width: '140px' }}>
            {scrollContainer && (
              <Anchor
                ...
                bounds={30}
              >
                <Anchor.Link href="#layout-intro" title="组件介绍" />
                <Anchor.Link href="#layout-basic" title="基础布局" />
                <Anchor.Link href="#layout-sider" title="侧边栏布局" />
                <Anchor.Link href="#layout-trigger" title="收缩按钮位置" />
                <Anchor.Link href="#layout-zero-width" title="零宽度收缩" />
                <Anchor.Link href="#layout-custom" title="自定义布局" />
                <Anchor.Link href="#layout-theme" title="主题颜色切换" />
                <Anchor.Link href="#layout-menu" title="结合 Menu" />
                <Anchor.Link href="#layout-api" title="API 文档" />
              </Anchor>
            )}
          </div>
        </div>
